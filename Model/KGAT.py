...
import tensorflow as tf2            # Changed by GTL for GlorotUniform
...
class KGAT(object):
    ...
    def _build_inputs(self):
        ...
        self.users = tf.compat.v1.placeholder(tf.int32, shape=(None,))         # Changed by GTL all tf.placehold add compat.v1 in btw
...
#         initializer = tf.contrib.layers.xavier_initializer()   # Changed by GTL
        initializer = tf2.initializers.GlorotUniform()          # Changed by GTL
